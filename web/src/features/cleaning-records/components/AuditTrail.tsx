import type { AuditChangeSet } from '../../../types/api';
...
export function AuditTrail({ changeSets, isLoading, error, onRetry }: AuditTrailProps) {
        ...
        <li key={set.changeSetId} className="rounded-lg bg-white p-3 ring-1 ring-slate-200">
          <div className="flex flex-wrap items-baseline gap-x-2 gap-y-1">
            ...
            <span className="text-xs text-slate-500">
              {set.action === 'CREATE' ? 'created this record' : 'updated this record'}
            </span>
